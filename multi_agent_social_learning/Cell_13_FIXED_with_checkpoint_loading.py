...
def train_multi_agent(method="proposed", total_steps=100000, n_agents=3,
    ...
    # ==================== NOW LOAD CHECKPOINTS IF AVAILABLE ====================
    checkpoint_dir = Path("/kaggle/input/multi-agent-trained-models")  # Change to your dataset name
    load_from_checkpoint = checkpoint_dir.exists()
    ...
    if load_from_checkpoint:
        ...
        for i in range(n_agents):
            ...
            if checkpoint_path.exists():
                ...
                # Update target networks to match
                ...
                print(f"⚠ Warning: Checkpoint not found for Agent {i}")
        print()
    else:
        # ==================== PRETRAIN IF NO CHECKPOINTS ====================
    ...
    # ==================== MAIN TRAINING (CONTINUES FROM CHECKPOINT) ====================
